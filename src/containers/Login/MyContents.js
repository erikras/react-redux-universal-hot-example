...
const { isLoaded, loadLessons, loadMyLessons } = lessonActions;
                  ...
                  return (
                    <div>
                      ...
                      <input  type="checkbox" name="active" value="active"
                        ...
                        />
                      <Button bsStyle="link" onClick={() => this.props.history.push(`/lesson/${item.id}/edit`)}>
                        {t('content.see_more')}
                      </Button>
                    </div>
                  );
