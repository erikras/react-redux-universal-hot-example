...
const { isLoaded, loadContents } = lessonActions;
...
@connect(
  state => ({
    directions: state.lesson.contents_by_lesson
  }),
  { ...lessonActions }
)
    ...
    return (
      <div className={styles.home}>
        ...
        <div className="container">
          <Button bsStyle="link" onClick={() => this.props.history.push(`/lesson/${this.props.params.id}/edit`)}>
            {t('content.editLesson')}
          </Button>
          <div>
            {
