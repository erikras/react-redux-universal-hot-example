    ...
    return (
      <div className="container">
        ...
        <p>This project was originally created by Erik Rasmussen
          ...
          <a href="https://github.com/erikras/react-redux-universal-hot-example/graphs/contributors"
            target="_blank"
        ...
        <p>Hey! You found the mini info bar! The following component is display-only.
        Note that it shows the same time as the info bar.</p>
